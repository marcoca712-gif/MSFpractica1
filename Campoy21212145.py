...
plt.plot(t,PIDu1,'--',linewidth = 3, color = clr5, label = 'PID(t)') # Respuesta en lazo cerrado
...
plt.plot(t,PIDu2,'--',linewidth = 3,color = clr5, label = 'PID(t)') # Respuesta en lazo cerrado
plt.xlim(0,10); plt.xticks(np.arange(0,11,1))
...
plt.plot(t,PIDu3,'--',linewidth = 3,color = clr5, label = 'PID(t)') # Respuesta en lazo cerrado
plt.xlim(0,10); plt.xticks(np.arange(0,11,1))
...
plt.plot(t,PIDu4,'--',linewidth = 3,color = clr5, label = 'PID(t)') # Respuesta en lazo cerrado
plt.xlim(0,10); plt.xticks(np.arange(0,11,1))
